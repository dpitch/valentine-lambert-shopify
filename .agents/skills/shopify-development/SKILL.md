...
shopify theme dev --store perolles29.myshopify.com  # Start local preview
```

> ⚠️ **Ce projet utilise GitHub sync** : Ne pas utiliser `shopify theme push/pull`.
> Déployer avec `git push origin main`.
